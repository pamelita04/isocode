...
GRANT SELECT ON SCHEMA::[dbo] TO [MyService];
GRANT INSERT ON SCHEMA::[dbo] TO [MyService];
GRANT UPDATE ON SCHEMA::[dbo] TO [MyService];
GRANT DELETE ON SCHEMA::[dbo] TO [MyService];
GO
GRANT SELECT ON SCHEMA::[dbo] TO [MyReporting];
GO
